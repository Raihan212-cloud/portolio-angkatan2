...
// masukan ke dalam table user (name, email, password) nilai nya 
...
if (isset($_POST['edit'])) {
    ...
    $queryUpdate = mysqli_query($config, "UPDATE users SET name='$nama', email='$email', password='$password' WHERE id='$id_user'");
    if ($queryUpdate) {
